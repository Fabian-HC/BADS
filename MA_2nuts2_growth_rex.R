...
# A_fit1_1900 <- lm(GDPpcGrowth ~ trade_center + ...,
...
A_fit1 <- df %>% filter(Year>1900) %>% nest_by(Year) %>%
  mutate(mod = list(lm(GDPpcGrowth ~ trade_center +
...
B_fit1 <- df %>% filter(Year>1900) %>% nest_by(Year) %>%
  mutate(mod = list(lm(GDPpcGrowth ~ ln_tc_dist +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
...
C_fit1 <- df %>% filter(Year>1900) %>% nest_by(Year) %>%
  mutate(mod = list(lm(GDPpcGrowth ~ trade_years +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
...
D_fit1 <- df %>% filter(Year>1900) %>% nest_by(Year) %>%
  mutate(mod = list(lm(GDPpcGrowth ~ tc_ratio +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
...
E_fit1 <- df %>% filter(Year>1900) %>% nest_by(Year) %>%
  mutate(mod = list(lm(GDPpcGrowth ~ tc_dens +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
