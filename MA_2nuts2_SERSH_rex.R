...
# A_fit1_1900 <- lm(SERSH ~ trade_center + ...,
...
A_fit1 <- df %>% nest_by(Year) %>%
  mutate(mod = list(lm(SERSH ~ trade_center +
...
B_fit1 <- df %>% nest_by(Year) %>%
  mutate(mod = list(lm(SERSH ~ ln_tc_dist +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
...
C_fit1 <- df %>% nest_by(Year) %>%
  mutate(mod = list(lm(SERSH ~ trade_years +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
...
D_fit1 <- df %>% nest_by(Year) %>%
  mutate(mod = list(lm(SERSH ~ tc_ratio +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
...
E_fit1 <- df %>% nest_by(Year) %>%
  mutate(mod = list(lm(SERSH ~ tc_dens +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
