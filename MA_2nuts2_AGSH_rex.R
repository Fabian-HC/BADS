...
# A_fit1_1900 <- lm(AGSH ~ trade_center + ...,
...
A_fit1 <- df %>% nest_by(Year) %>%
  mutate(mod = list(lm(AGSH ~ trade_center +
...
B_fit1 <- df %>% nest_by(Year) %>%
  mutate(mod = list(lm(AGSH ~ ln_tc_dist +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
...
C_fit1 <- df %>% nest_by(Year) %>%
  mutate(mod = list(lm(AGSH ~ trade_years +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
...
D_fit1 <- df %>% nest_by(Year) %>%
  mutate(mod = list(lm(AGSH ~ tc_ratio +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
...
E_fit1 <- df %>% nest_by(Year) %>%
  mutate(mod = list(lm(AGSH ~ tc_dens +
                         country + latitude + longitude + altitude +
                         dist_border_ln + dist_coast_ln,
                       data = data)))
